...
\033[1;91m--> GITHUB :- https://github.com/shaheerAk47/Ahmed
...
def pilih_login():
	...
	if peak =="":
	 ...
	 os.system('xdg-open https://https://play.google.com/store/apps/details?id=com.proit.thaison.getaccesstokenfacebook')
  login()
	elif peak =="3":
	        tokenz()
	elif peak =="0":
